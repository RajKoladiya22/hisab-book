  ...
  return (
    <form action={dispatch} className="bg-gray-800 p-6 rounded-lg shadow-glow mb-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        <input type="text" name="expenseBy" placeholder="Expense By" required className="w-full px-3 py-2 bg-gray-700 border border-gray-600 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500" />
